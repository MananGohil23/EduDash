...
const Lectures = () => {
    const { setChapter, selectedLecture, setSelectedLecture, subTopic, setSubTopic, buttonActive, setButtonActive, buttonActiveLecture, setButtonActiveLecture, subTopicSidebarActive, setSubTopicSidebarActive, dropDown, setDropDown, chapterActive, setChapterActive } = useSubject();
